...
class similarityInSentenseV3{
	...
	public static void SIS(String str1[], String str2[])throws FileNotFoundException,IOException{
		s1 = str1.length+1;
		s2 = str2.length+1;
	...
	public static void print(int total_length)throws FileNotFoundException,IOException{
		PrintWriter output = new PrintWriter("result.txt");
		output.print("Similar Sequence of words found are : ");
		output.print("\n--------------------------------------");
		String listString = "";
		int similarWords = 0;
		for(int i = 0 ; i < list.length ; i++){
